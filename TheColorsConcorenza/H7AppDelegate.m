...
{    
    ...
    [FBLoginView class];
    // Save Initial Data
    H7AddDataToManagedObject *add = [[H7AddDataToManagedObject alloc] init];
    [add saveData];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TheColorsConcorenza" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TheColorsConcorenza.sqlite"];
